...
int main()
{
	...
	{
		std::cout << "***\nMain 1\nCheck deep copy of Dog (no double free + first thoughts are different), using copy constructor:" << std::endl;
		Dog *dogA = new Dog;
	...
	{
		std::cout << "***\nMain 2\nCheck deep copy of Cat (no double free + first thoughts are different), using assignment operator overload:" << std::endl;
		Cat *catA = new Cat;
		Cat *catB = new Cat;
